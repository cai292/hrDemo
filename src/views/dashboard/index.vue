  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imagerror="require('@/assets/common/head.jpg')" :src="staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ name }} |   {{ $store.state.user.userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第1期 团队互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第2期  团队互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第3期 团队互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            ...
            <el-button class="sideBtn" @click="leaveshowDialog=true">请假调休</el-button>
    ...
    <dimission :show-dialog.sync="showDialog" />
    <leave :leaveshow-dialog.sync="leaveshowDialog" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    //       await startProcess({ ...this.ruleForm, userId: this.$store.getters.userId, processKey: this.ruleForm.processKey === 'process_dimission' })
    //     } else {
    //       await startProcess({ ...this.ruleForm, userId: this.$store.getters.userId, processKey: this.ruleForm.processKey === 'process_overtime' })
    //     }
